...
###|Main Window|##########################################################\
window = Tk()
window.title("-=| FEEL GOOD FUND Budgeting System - Employee Access |=-")
...
labelRequest = Label(window, text = "  REQUEST EDIT", font=("Courier New",28,"bold"), fg="Black", bg="Salmon")
labelRequest.place(x = 250 , y = 100)
##########################################################################/
...
###|Setting Up Buttons|###################################################\
buttonSumbit = Button(window, font=("Courier New",18,"bold"), fg="Black", bg="Salmon", activeforeground="Red", text="Request",command=clearEntries, width = 7, height = 2)
