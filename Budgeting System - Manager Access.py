##########################################################################\
# FEEL GOOD FUND Budgeting System using Tkinter and SQL Database
# By : Lloyd Alex Porter -=- Created : Mon-8-Feb-2021
##########################################################################/
...
###|Main Window|##########################################################\
window = Tk()
window.title("-=| FEEL GOOD FUND Budgeting System - Manager Access |=-")
...
###|Title|################################################################\
title = Label(window, text="BUDGET CALCULATOR", font=("Georgia",42,"bold italic"), fg="Dark Red", bg="Salmon", justify="center")
...
###|Setting Up Labels|####################################################\
labelName = Label(window, text = "Name   :", font=("Courier New",20,"bold"), fg="Black", bg="Salmon")
labelName.place(x = 100 , y = 150)
labelAmount = Label(window, text = "Amount :", font=("Courier New",20,"bold"), fg="Black", bg="Salmon")
labelAmount.place(x = 100 , y = 200)
labelPositive = Label(window, text = "+ ", font=("Courier New",32,"bold"), fg="Forest Green", bg="Salmon")
labelPositive.place(x = 700 , y = 355)
labelNegative = Label(window, text = "- ", font=("Courier New",32,"bold"), fg="Red", bg="Salmon")
labelNegative.place(x = 700 , y = 420)
labelSumLine = Label(window, text = "________________________", font=("Courier New",18,"bold"), fg="Black", bg="Salmon")
labelSumLine.place(x = 740 , y = 455)
labelSumLine = Label(window, text = "========================", font=("Courier New",18,"bold"), fg="Black", bg="Salmon")
labelSumLine.place(x = 740 , y = 530)
labelEquals = Label(window, text = "= ", font=("Courier New",32,"bold"), fg="Black", bg="Salmon")
...
###|Setting Up Entries|###################################################\
entryName = Entry(window, textvariable=valueName, font=("Courier New",20), fg="Black", bg="Salmon", bd = 0, width = 22)
entryName.place(x = 250 , y = 150)
entryAmount = Entry(window, textvariable=valueAmount, font=("Courier New",20), fg="Black", bg="Salmon", bd = 0, width = 22)
...
progressBar = Label(window, textvariable=progress, font=("Courier New",14,"bold"), fg="Black", bg="Salmon")
progressBar.place(x = 12, y = 650)
progressInfomation = Label(window, textvariable=progressStats, font=("Courier New",14,"bold"), fg="Black", bg="Salmon")
...
def openIncomeDatabase():
        ...
        listBoxIncome = Listbox(frame, height = 13, width = 32, font=("Courier New",14), fg="Black", bg="Salmon", selectmode=SINGLE)
        listBoxIncome.pack(side = LEFT, fill = Y)
        
        scroll = Scrollbar(frame, orient = VERTICAL,bg="Salmon")
...
def openOutgoingsDatabase():
        ...
        listBoxOutgoings = Listbox(frame, height = 13, width = 32, font=("Courier New",14), fg="Black", bg="Salmon", selectmode=SINGLE)
...
radioWeekly = Radiobutton(window, text = "Weekly", font=("Courier New",16,"bold"), fg="Black", bg="Salmon", variable = selectTimeScale, value = "Weekly", command = openDatabases)
radioWeekly.place(x = 950, y = 10)
radioMonthly = Radiobutton(window, text = "Monthly", font=("Courier New",16,"bold"), fg="Black", bg="Salmon", variable = selectTimeScale, value = "Monthly", command = openDatabases)
radioMonthly.place(x = 950, y = 40)
radioYearly = Radiobutton(window, text = "Yearly", font=("Courier New",16,"bold"), fg="Black", bg="Salmon", variable = selectTimeScale, value = "Yearly", command = openDatabases)
radioYearly.place(x = 950, y = 70)
radioIncome = Radiobutton(window, text = "Income", font=("Courier New",22,"bold"), fg="Black", bg="Salmon", variable = selectInOrOut, value = "Income", command = openDatabases)
radioIncome.place(x = 125, y = 100)
radioOutgoings = Radiobutton(window, text = "Outgoing", font=("Courier New",22,"bold"), fg="Black", bg="Salmon", variable = selectInOrOut, value = "Outgoings", command = openDatabases)
...
###|Setting Up Buttons|###################################################\
buttonSumbit = Button(window, font=("Courier New",18,"bold"), fg="Black", bg="Salmon", activeforeground="Red", text="Submit",command=submitData, width = 7, height = 2)
buttonSumbit.place(x = 240 , y = 240)
buttonClear = Button(window, font=("Courier New",18,"bold"), fg="Black", bg="Salmon", activeforeground="Red", text="Clear",command=clearEntries, width = 7, height = 2)
buttonClear.place(x = 350 , y = 240)
buttonDelete = Button(window, font=("Courier New",18,"bold"), fg="Black", bg="Salmon", activeforeground="Red", text="Delete",command=deleteData, width = 7, height = 2)
buttonDelete.place(x = 460 , y = 240)
buttonChart = Button(window, font=("Courier New",18,"bold"), fg="Black", bg="Salmon", activeforeground="Red", text="Create Chart",command=launchChart, width = 15, height = 3)
...
labelUpdatePositive = Label(window, textvariable = valueIncomeTotal, font=("Courier New",32,"bold"), fg="Black", bg="Salmon")
labelUpdatePositive.place(x = 755 , y = 355)
labelUpdateNegative = Label(window, textvariable = valueOutgoingsTotal, font=("Courier New",32,"bold"), fg="Black", bg="Salmon")
labelUpdateNegative.place(x = 755 , y = 420)
labelUpdateEquals = Label(window, textvariable = valueTotal, font=("Courier New",32,"bold"), fg="Black", bg="Salmon")
